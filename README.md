...
10. [Pareto-Efficient Hybridization for Multi-Objective Recommender Systems](https://dl.acm.org/doi/10.1145/2365952.2365962) `Universidade Federal de Minas Gerais` `Zunnit Technologies` `RecSys 2012`
...
18. [Movie Recommender System for Profit Maximization](https://u.cs.biu.ac.il/~sarit/data/articles/rec025-azaria_Movie.pdf) `RecSys 2013`



### Bias in Ranking
1. [On Bias Problem in Relevance Feedback](https://dl.acm.org/doi/abs/10.1145/2063576.2063866) `Tsinghua University` `University of California` `CIKM 2011`
2. [Towards an Effective and Unbiased Ranking of Scientific Literature through Mutual Reinforcement](https://dl.acm.org/doi/abs/10.1145/2396761.2396853) `CIKM 2012`
3. [A Retrievability Analysis: Exploring the Relationship Between Retrieval Bias and Retrieval Performance](https://dl.acm.org/doi/10.1145/2661829.2661948) `University of Glasgow` `CIKM 2014`
4. [Algorithmic Bias: Do Good Systems Make Relevant Documents More Retrievable?](https://pure.strath.ac.uk/ws/portalfiles/portal/71288218/Wilkie_Azzopardi_CIKM_2017_Algorithmic_bias_do_good_systems_make_relevant_documents_more_retrievable.pdf) `University of Glasgow` `University of Strathclyde` `CIKM 2017`
5. [Differentiable Unbiased Online Learning to Rank](https://arxiv.org/abs/1809.08415) `University of Amsterdam` `CIKM 2018`
6. [Estimating Clickthrough Bias in the Cascade Model](http://pchandar.github.io/static/Chandar2018-158844a038c1fa3e1433db7c7b0a6e91.pdf) `Spotify` `CIKM 2018`
7. [Correcting for Recency Bias in Job Recommendation](http://rueycheng.com/paper/recency-bias.pdf) `RMIT University` `University of Utah` `GO1` `CIKM 2019`
8. [On Heavy-user Bias in A/B Testing](https://arxiv.org/abs/1902.02021) `UC Berkeley` `Microsoft` `CIKM 2019`
9. [Managing Popularity Bias in Recommender Systems with Personalized Re-ranking](https://arxiv.org/abs/1901.07555) `University of Colorado` `DePaul University` `FLAIRS 2019`
10. [A Methodology for Learning, Analyzing, and Mitigating Social Influence Bias in Recommender Systems](https://amplab.cs.berkeley.edu/wp-content/uploads/2014/07/krishnan-recsys-v16.pdf) `UC Berkeley` `RecSys 2014`
11. [On Over-Specialization and Concentration Bias of Recommendations: Probabilistic Neighborhood Selection in Collaborative Filtering Systems](http://people.stern.nyu.edu/padamopo/On%20Over-Specialization%20and%20Concentration%20Bias%20of%20Recommendations.pdf) `NYU` `RecSys 2014`
12. [Controlling Popularity Bias in Learning to Rank Recommendation](https://scds.cdm.depaul.edu/wp-content/uploads/2017/05/SOCRS_2017_paper_5.pdf) `DePaul University` `RecSys 2017`
13. [Modeling the Assimilation-Contrast Effects in Online Product Rating Systems: Debiasing and Recommendations](https://cseweb.ucsd.edu/classes/fa17/cse291-b/reading/Modeling%20the%20Assimilation-Contrast%20Effects%20in%20Online%20Product%20Rating%20Systems%20Debiasing%20and%20Recommendations.pdf) `CUHK` `RecSys 2017`
14. [Sampling-Bias-Corrected Neural Modeling for Large Corpus Item Recommendations](https://dl.acm.org/doi/10.1145/3298689.3346996) `Google` `RecSys 2019`
15. [Sample Selection Bias Correction Theory](https://static.googleusercontent.com/media/research.google.com/en//pubs/archive/34675.pdf) `Google` 
16. [Addressing Marketing Bias in Product Recommendations](https://arxiv.org/abs/1912.01799) `Airbnb` `UCSD` `Twitter` `WSDM 2020`
...
## Sampling
1. [Active Sampling for Entity Matching with Guarantees](http://ilpubs.stanford.edu:8090/1056/) `Facebook` `Microsoft` `Stanford` `Google`
2. [iSampling: Framework for Developing Sampling Methods Considering User’s Interest](http://dm.postech.ac.kr/techreport/TechReport-POSTECH-CSE-2012-08-iSampling.pdf) `Pohang University of Science and Technology` `CIKM 2012`
3. [CGMOS: Certainty Guided Minority OverSampling](https://arxiv.org/abs/1607.06525) `CIKM 2016`
4. [Compression-Based Selective Sampling for Learning to Rank](https://homepages.dcc.ufmg.br/~msalvim/publications/2016-CIKM.pdf) `Federal University of Minas Gerais` `CIKM 2016`
5. [A Personalised Ranking Framework with Multiple Sampling Criteria for Venue Recommendation](http://www.dcs.gla.ac.uk/~craigm/publications/multi-criteria-sampling.pdf) `University of Glasgow` `CIKM 2017`
6. [Active Sampling for Large-scale Information Retrieval Evaluation](https://arxiv.org/abs/1709.01709) `University of Amsterdam` `CIKM 2017`
7. [Adaptive Feature Sampling for Recommendation with Missing Content Feature Values](http://www.thuir.cn/group/~mzhang/publications/CIKM2019-ssy.pdf) `Tsinghua University` `Rutgers University` `CIKM 2019`
8. [Efficiently Learning the Accuracy of Labeling Sources for Selective Sampling](https://www.cs.cmu.edu/~jgc/publication/PublicationPDF/Efficiently_Learning_The_Accuracy_Of_Labeling_Sources_For_Selective_Sampling.pdf) `CMU` `KDD 2009`
9. [Active Sampling for Entity Matching](https://research.fb.com/wp-content/uploads/2012/08/active-sampling-for-entity-matching.pdf) `Yahoo` `Stanford`
10. [Batch Mode Active Sampling based on Marginal Probability Distribution Matching](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4191836/) `KDD 2012`
11. [Selective Sampling on Graphs for Classification](http://web.cs.ucla.edu/~qgu/pdf/kdd13.pdf) `IBM` `KDD 2013`
12. [Sampling for Big Data](https://nickduffield.net/download/papers/Tutorial_KDD_2014.pdf) `University of Warwick` `Texas A&M University` `KDD 2014`
13. [On Sampling Strategies for Neural Network-based Collaborative Filtering](https://arxiv.org/abs/1706.07881) `University of California` `Yahoo` `Etsy Inc.` `KDD 2017`
14. [Sampling-Bias-Corrected Neural Modeling for Large Corpus Item Recommendations](https://dl.acm.org/doi/10.1145/3298689.3346996) `Google` `KDD 2019`
